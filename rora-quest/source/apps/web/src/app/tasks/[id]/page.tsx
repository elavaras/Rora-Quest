          ...
          {takeover ? (
            ...
            <>
              ...
              <div className="card">
                ...
                <div className="grid-2" style={{ marginTop: "0.75rem" }}>
                  <div>
                    ...
                    <input
                      ...
                      disabled={isDsaLocked || addingSubStep || savingStatus || togglingSubStepId !== null || removingSubStepId !== null}
                    />
                  </div>
                  <div>
                ...
                <div className="row" style={{ marginTop: "0.75rem" }}>
                  <button
                    disabled={isDsaLocked || addingSubStep || savingStatus || togglingSubStepId !== null || removingSubStepId !== null || !subStepTitle.trim() || hasInvalidSubStepWeight}
                    ...
                    <li key={s.id} className="substep-row">
                      <label className="substep-check">
                        <input
                          type="checkbox"
                          checked={s.isDone}
                         disabled={savingStatus || togglingSubStepId !== null || addingSubStep || removingSubStepId !== null}
